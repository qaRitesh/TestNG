...
public class InventoryInvoiceSelectAccountNamePage_OR extends CommonReusableCode{

	
	public InventoryInvoiceSelectAccountNamePage_OR(WebUtil wD) {
		super(wD);
