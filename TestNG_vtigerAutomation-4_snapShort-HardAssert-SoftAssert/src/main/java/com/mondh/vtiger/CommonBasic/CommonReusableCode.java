...
//checkDataStore:
	public void checkDataStoreorNot(String columnbas, String expectedString) {
...
//update_match:
	public void checkUpdateData(String columnbas, String oldData, String newData) {
		...
		Assert.assertEquals(we, newData);
	}
	
//SearchOptionbase_findItemcheck:
	public void checkSearchOptionBaseData(String basoption,String expectedString) {
...
//Delete_Data:
	public void checkDeleteDataOrNot(String columnName,String expectedString) {
		...
		if(num==0) {
			System.out.println("PASS:the Acutal Data not Store && Expected "+expectedString);						
		}else {
			System.out.println("Fail: the Acutal Data Store && Expected "+expectedString);
		}
