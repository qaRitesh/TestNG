...
//getAttributevalue:
	public String getAttributevalue(WebElement weObj, String valueText) {
...
//verifytext:	
	public void verifyText(String acutalString,String expectedString){
		if(acutalString.equalsIgnoreCase(expectedString)) {
			System.out.println("PASS:the Acutal "+acutalString+" && Expected "+expectedString);
		}else {
			System.out.println("FAIL:the Acutal "+acutalString+" && Expected "+expectedString);
		}
...
//myverifyString:
	public void VerifyInnerText(WebElement we, String expectedText) {
		...
		if (acutalText.equalsIgnoreCase(expectedText)) {
			System.out.println("Passed.Actual-- "+acutalText +" && Expected- "+expectedText);
		} else {
			System.out.println("Failed.Actual-- "+acutalText + "&& Expected- "+expectedText);
		}
...
//myverifynumber:
	public void VerifyNumber(int acutalNumber, int expectedNumber) {
		...
		if (acutalNumber == expectedNumber) {
			System.out.println("Passed.Actual-- "+ acutalNumber +" && Expected- "+ expectedNumber);
		} else {
			System.out.println("Failed.Actual-- "+ acutalNumber +" && Expected- "+ expectedNumber);
		}		
...
//verifyURL:
		...
		if(actualisEnabled==expectedisEnabled) {
			System.out.println("Passed.Actual-- "+ actualisEnabled +" && Expected- "+ expectedisEnabled);
		}else {
			System.out.println("Passed.Actual-- "+ actualisEnabled +" && Expected- "+ expectedisEnabled);
		}
...
//verifyURL:
		...
		if(actualisDisplayed==expectedisDisplayed) {
			System.out.println("Passed.Actual-- "+ actualisDisplayed +" && Expected- "+ expectedisDisplayed);
		}else {
			System.out.println("Passed.Actual-- "+ actualisDisplayed +" && Expected- "+ expectedisDisplayed);
		}
